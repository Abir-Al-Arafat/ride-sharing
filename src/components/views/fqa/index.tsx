                        ...
                        {questionsData.map((item, index) => (
                            <div key={index} className="flex">
                                    ...
                                    >
                                        ...
                                        <span>
                                            {activeAccordion === index ? (
                                                <ChevronUp size={27} className="bg-[#F0F0F0] text-primary rounded-full p-1" />
                                            ) : (
                                                <ChevronDown size={27} className="bg-[#F0F0F0] text-primary rounded-full p-1" />
                                            )}
                                        </span>
                                    </div>
                                    <div
                                ...
                                <div className="ml-2 w-32 flex gap-2">
                                    <h1 className="bg-[#E4FFEB] py-4 px-4 h-fit rounded-sm cursor-pointer"><SquarePen size={16} className="text-[#28A745]" /></h1>
                                    <h1 className="bg-[#FFE5E5] py-4 px-4 h-fit rounded-sm cursor-pointer"><Trash2 size={16} className="text-[#FF0000]" /></h1>
                                </div>
                            </div>
                        ))}
                    </div>
                </div>
                <Button variant={"main"} className="px-12">Add More</Button>
            </div>
        </div>
    )
}
